...
# Write the dictionary to the file using json.dump
    with open("report/report_details.txt", "a") as f:
    ...
    # Write the dictionary to the file using json.dump
    with open("report/report_simple.txt", "a") as f:
        json.dump(data, f)
        f.write("\n")
...
if __name__ == "__main__":
    ...
    parser.add_argument("test_input", type=Path,nargs='?', default=Path('test_input/prompt1.json'))
